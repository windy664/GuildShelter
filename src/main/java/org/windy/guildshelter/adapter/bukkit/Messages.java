...
public final class Messages {
    ...
    static {
        ...
        put("error.move_no_manor", "§e你还没有地皮，无法搬家。");
        ...
        // === 成功消息 ===
        put("success.home_teleported", "§6✦ §a已回到你的地皮 §f#%s");
        put("success.spawn_teleported", "§6✦ §a已传送到公会主城");
        put("success.middle_teleported", "§6✦ §a已传送到地皮 §f#%s §a正中心");
        ...
        put("success.trust_added", "§b🤝 §f%s §a已成为地皮 §f#%s §a的共建人");
        ...
        put("success.trust_batch", "§b🤝 §a批量添加 §f%s §a人为地皮 §f#%s §a的共建人");
        ...
        put("success.denied_added", "§c🚫 §f%s §a已加入地皮 §f#%s §a黑名单");
        ...
        put("success.denied_batch", "§c🚫 §a批量拉黑 §f%s §a人（地皮 §f#%s§a）");
        put("success.flag_set", "§e⚙ §f%s §7= §a%s §8(地皮 #%s)");
        put("success.flag_unset", "§e⚙ §f%s §7已重置为默认 §8(%s)");
        put("success.alias_set", "§e✎ §a地皮别名: §f%s");
        put("success.alias_cleared", "§e✎ §7已清除地皮别名");
        put("success.home_set", "§d⌂ §a传送点已设为 §f%s, %s, %s");
        put("success.done_on", "§a✔ §a地皮已标记为 §f完工");
        put("success.done_off", "§e🔨 §7已取消完工标记（建造中）");
        put("success.kicked", "§c⏎ §a已将 §f%s §a踢出你的地皮");
        put("success.kicked_notify", "§c⚠ §7你被 §f%s §7从地皮 §f#%s §7踢出了");
        put("success.cleared", "§6✦ §a地皮 §f#%s §a地表已清空 §7— 整地进行中...");
        put("success.rated", "§6★ §a评分成功！地皮 §f#%s §7: §e%s §7分 §8(平均 §e%s§8, §f%s §8人评)");
        put("success.merged", "§6⊕ §a地皮 §f#%s §a已并入 §f#%s §7— 路 chunk 归属完成");
        put("success.unmerged_one", "§6⊖ §a地皮 §f#%s §a合并已取消 §7— 路 chunk 已恢复");
        put("success.unmerged_all", "§6⊖ §a已取消 §f#%s §a的全部合并 §8(共 %s 块)");
        put("success.desc_set", "§e✎ §a描述: §f%s");
        put("success.desc_cleared", "§e✎ §7已清除地皮描述");
        put("success.regen", "§6✦ §a地皮 §f#%s §a地形已重置 §7— 整地进行中...");
        put("success.export", "§6📦 §a导出完成: §f%s");
        put("success.reload", "§6♻ §a配置已重载 §7(部分设置需重启)");
        put("success.setowner", "§6👑 §a地皮 §f#%s §a庄主已转移给 §f%s");
        put("success.purge", "§6✦ §a已清理 §f%s §a块闲置地皮 §8(超过 %s 天未登录)");
        ...
        put("success.create_world", "§6✦ §a公会世界已创建 §f%s §8| §7种子=§f%s §8| §7偏移=§f(%s,%s)");
        put("success.claim", "§6✦ §a地皮 §f#%s §a已分配 §8(等级 %s) §7— 整地进行中，传送中...");
        ...
        put("success.fill", "§6✦ §a已为 §f%s §a填充 §f%s §a块测试地皮");
        put("success.fill_full", "§e⚠ §a已达上限 §f%s §a块 §8(已填 %s) §7— 先升级公会");
        put("success.map", "§6✦ §a网格图已输出到控制台");
        put("success.swap", "§6⇄ §a互换完成 §f#%s §7↔ §f#%s §8(与 %s)");
        put("success.swap_notify", "§6⇄ §f%s §7与你互换了地皮 §f#%s §7↔ §f#%s");
        put("success.grant", "§6✦ §a已为 §f%s §a分配新地皮");
        ...
        put("success.template_applied", "§6✦ §a模板 §f%s §a已应用到地皮 §f#%s §8(%s 个 flag)");
        ...
        put("success.comment_added", "§6✎ §a留言已发送到地皮 §f#%s");
        put("success.plot_opened", "§6🔓 §a地皮已临时开放 §f%s §7— 访客可自由进出");
        put("success.plot_closed", "§6🔒 §a地皮已关闭访客模式");
        put("error.plot_not_open", "§e⚠ §7你的地皮当前未开放");
        put("success.flower_sent", "§d🌸 §a你给 §f%s §a送了一朵花 §8(今日第 %s 朵)");
        put("success.flower_received", "§d🌸 §f%s §a给你的地皮 §f%s §a送了一朵花！");
        put("error.cannot_flower_self", "§e⚠ §7不能给自己的地皮送花");
        put("error.already_flowered_today", "§e⚠ §7你今天已经给这块地皮送过花了");
        ...
        put("success.template_saved", "§6✦ §a建筑模板 §f%s §a已保存 §7(从你当前地皮范围)");
        put("success.template_pasted", "§6✦ §a建筑模板 §f%s §a已粘贴到你的地皮");
        put("info.no_schematics", "§e⚠ §7还没有保存任何建筑模板");
        put("info.schematics_header", "§6§l━━ §e§l📐 建筑模板 §6§l━━━━━━━━━━━━");
        put("info.schematics_entry", "§6▸ §f%s");
        put("usage.template_save", "§e用法: /gs template save <名称> §7(把地皮存为建筑模板)");
        put("usage.template_paste", "§e用法: /gs template paste <名称> §7(把模板粘贴到地皮)");
        ...
        put("info.card_plot", "§6│ §7地皮 §f%s §8· §7公会 §f%s §8· §7等级 §f%s%s");
        ...
        put("info.board_empty", "§e⚠ §7这块地皮还没有留言");

        // === 帮助用法 ===
        // --- /gs help 分类标题（沿用原有 §6==== 标题 ==== 风格）---
        put("info.help_cat_teleport", "§6==== 传送 ====");
        put("info.help_cat_info", "§6==== 地皮信息 ====");
        put("info.help_cat_people", "§6==== 人员管理 ====");
        put("info.help_cat_settings", "§6==== 地皮设置 ====");
        ...
        put("info.help_ln_home", "§e/gs home §7- 传送到自己地皮");
        put("info.help_ln_spawn", "§e/gs spawn §7- 传送到公会主城");
        put("info.help_ln_middle", "§e/gs middle §7- 传送到地皮正中心");
        put("info.help_ln_sethome", "§e/gs sethome §7- 设置 home 传送点");
        put("info.help_ln_visit", "§e/gs visit <公会> §7- 到访公会主城");
        put("info.help_ln_info", "§e/gs info §7- 查看地皮+公会信息");
        put("info.help_ln_card", "§e/gs card [玩家] §7- 查看地皮档案卡");
        put("info.help_ln_near", "§e/gs near §7- 列出附近地皮");
        ...
        put("info.help_ln_open", "§e/gs open [分钟] §7- 临时开放地皮");
        put("info.help_ln_close", "§e/gs close §7- 关闭访客模式");
        put("info.help_ln_comment", "§e/gs comment <留言> §7- 给地皮留言");
        put("info.help_ln_inbox", "§e/gs inbox §7- 查看收到的留言");
        put("info.help_ln_rate", "§e/gs rate <1-10> [公会 slot] §7- 给地皮打分");
        put("info.help_ln_flower", "§e/gs flower [公会 slot] §7- 给地皮送花");
        ...
        put("info.help_ln_merge", "§e/gs merge <slot> §7- 合并相邻地皮（需确认）");
        ...
        put("info.help_ln_admin_create", "§c/gs admin create <公会> [地形] §7- 创建公会世界");
        put("info.help_ln_admin_tp", "§c/gs admin tp <公会> §7- 传送到公会主城");
        put("info.help_ln_admin_claim", "§c/gs admin claim <公会> §7- 给自己分配地皮");
        put("info.help_ln_admin_fill", "§c/gs admin fill <公会> <数量> §7- 批量填充测试地皮");
        ...
        put("info.help_ln_admin_delete", "§c/gs admin delete <公会> §7- 卸载公会世界");
        ...
        put("info.help_ln_admin_purge", "§c/gs admin purge <天数> [公会] §7- 清理闲置地皮");
        put("info.help_ln_admin_regen", "§c/gs admin regen §7- 重置脚下地皮地形");
        ...
        // === 监听器 ===
        put("listener.blacklisted", "§c🚫 §7你在这块地皮的黑名单中，无法进入");
        put("listener.deny_entry", "§c🔒 §7这块地皮谢绝访客");
        put("listener.deny_exit", "§c🔒 §7你被困在这块地皮里了");
        put("listener.cmd_blocked", "§c🚫 §7此地皮禁止使用 §f/%s");
        put("listener.price_charged", "§6💰 §7入场费 §e%s §7已扣除 §8(地皮 #%s)");
